...
.PHONY: install-dev lint test run-api run-ui run-etl-extract run-etl-transform run-etl-chunk run-etl-load run-eval run-eval-sweep run-demo-traffic up down
